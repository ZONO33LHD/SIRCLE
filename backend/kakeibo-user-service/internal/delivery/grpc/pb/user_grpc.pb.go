...
const (
	...
	UserService_SetBudget_FullMethodName                     = "/user.UserService/SetBudget"
	UserService_SetGoal_FullMethodName                       = "/user.UserService/SetGoal"
...
type UserServiceClient interface {
	...
	// 目標を設定
	SetGoal(ctx context.Context, in *SetGoalRequest, opts ...grpc.CallOption) (*Goal, error)
	// 通知設定を更新
...
func (c *userServiceClient) SetBudget(ctx context.Context, in *SetBudgetRequest, opts ...grpc.CallOption) (*Budget, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Budget)
	err := c.cc.Invoke(ctx, UserService_SetBudget_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userServiceClient) SetGoal(ctx context.Context, in *SetGoalRequest, opts ...grpc.CallOption) (*Goal, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Goal)
	err := c.cc.Invoke(ctx, UserService_SetGoal_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserServiceServer interface {
	...
	// 目標を設定
	SetGoal(context.Context, *SetGoalRequest) (*Goal, error)
	// 通知設定を更新
...
func (UnimplementedUserServiceServer) SetBudget(context.Context, *SetBudgetRequest) (*Budget, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SetBudget not implemented")
}
func (UnimplementedUserServiceServer) SetGoal(context.Context, *SetGoalRequest) (*Goal, error) {
...
func _UserService_SetBudget_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SetBudgetRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserServiceServer).SetBudget(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UserService_SetBudget_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).SetBudget(ctx, req.(*SetBudgetRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _UserService_SetGoal_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SetGoalRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserServiceServer).SetGoal(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UserService_SetGoal_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).SetGoal(ctx, req.(*SetGoalRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var UserService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _UserService_SetBudget_Handler,
		},
		{
			MethodName: "SetGoal",
			Handler:    _UserService_SetGoal_Handler,
		},
		{
